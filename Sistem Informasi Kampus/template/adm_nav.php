...
<nav class="navbar navbar-default main-nav">
  ...
  <div class="navbar-header">
    ...
    <ul class="nav navbar-nav">
      <li class="active"><a href="../admin/adm_home.php" style="color: black;">Home</a></li>
      <li><a href="../admin/adm_mahasiswa.php" style="color: white;">Data Mahasiswa</a></li>
      <li><a href="../admin/adm_matkul.php" style="color: white;">Data Mata Kuliah</a></li>
      <li><a href="../admin/adm_dosen.php" style="color: white;">Data Dosen</a></li>
    </ul>
